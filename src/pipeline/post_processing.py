...
with open("../data/outputs/baseline-solution-cities-20210207-143727-0-0.pickle","rb") as f:
...
with open("../data/outputs/baseline-solution-cases-20210207-143727-0-2.pickle","rb") as f:
    solution = pickle.load(f)
